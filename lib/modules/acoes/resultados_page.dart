...
class ResultadosPage extends StatefulWidget {
  ...
  @override
  State<ResultadosPage> createState() =>
      _ResultadosPageState();
}

class _ResultadosPageState
    extends State<ResultadosPage> {
  final pessoasController =
      TextEditingController();

  final veiculosController =
      TextEditingController();

  final credenciaisController =
  ...
  void salvarResultados() {
    ...
    if (!metaAtingida &&
      ...
      ScaffoldMessenger.of(context)
        ...
        const SnackBar(
          content: Text(
            'Informe o motivo da meta não atingida.',
          ),
        ),
      );
      return;
