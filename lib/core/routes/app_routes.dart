...
class AppRoutes {
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/nova-acao', builder: (context, state) => const NovaAcaoPage()),
      GoRoute(path: '/localizacao', builder: (context, state) => const LocalizacaoPage()),
      GoRoute(path: '/resultados', builder: (context, state) => const ResultadosPage()),
      GoRoute(path: '/evidencias', builder: (context, state) => const EvidenciasPage()),
      GoRoute(path: '/avaliacao', builder: (context, state) => const AvaliacaoPage()),
      GoRoute(path: '/revisao', builder: (context, state) => const RevisaoRelatorioPage()),
      GoRoute(path: '/dashboard', builder: (context, state) => const DashboardPage()),
      GoRoute(path: '/admin', builder: (context, state) => const AdminPage()),
      GoRoute(path: '/usuarios', builder: (context, state) => const UsuariosPage()),
      GoRoute(path: '/tipos-acoes',  builder: (context, state) => const TiposAcoesPage()),
      GoRoute(path: '/coordenadores',  builder: (context, state) => const CoordenadoresPage()),
      GoRoute(path: '/regionais',  builder: (context, state) => const RegionaisPage()),
